...
<head>
    ...
    <title>Amado - Admin Dasboard</title>
...
<!-- navbar-->
<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="{{url('admin')}}" class="navbar-brand font-weight-bold text-uppercase text-base">Amado Dashboard</a>
...
<div class="d-flex align-items-stretch">
    <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
            <li class="sidebar-list-item"><a href="{{url('/admin')}}" class="sidebar-link text-muted"><i class="o-home-1 mr-3 text-gray"></i><span>Home</span></a></li>
            ...
            <li class="sidebar-list-item"><a href="{{url('/admin-products')}}" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>Product</span>
            <li class="sidebar-list-item"><a href="{{url('/admin-categories')}}" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>Category</span>
            <li class="sidebar-list-item"><a href="{{url('/admin-brands')}}" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>Brand</span>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-uppercase mb-0">Category Table</h6>
                            </div>
                            <div class="card-body">
